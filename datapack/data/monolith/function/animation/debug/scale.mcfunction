# Run as a player. Five blocks scale from 0.25 to 1.5 over 60 ticks.
...
execute as @e[tag=monolith.debug.linear] run function monolith:animation/start {property:"scale_xyz",from:250,to:1500,duration:60,easing:"linear"}
execute as @e[tag=monolith.debug.in_quad] run function monolith:animation/start {property:"scale_xyz",from:250,to:1500,duration:60,easing:"in_quad"}
execute as @e[tag=monolith.debug.out_quad] run function monolith:animation/start {property:"scale_xyz",from:250,to:1500,duration:60,easing:"out_quad"}
execute as @e[tag=monolith.debug.in_out_quad] run function monolith:animation/start {property:"scale_xyz",from:250,to:1500,duration:60,easing:"in_out_quad"}
execute as @e[tag=monolith.debug.out_back] run function monolith:animation/start {property:"scale_xyz",from:250,to:1500,duration:60,easing:"out_back"}
